...
namespace CaseStudy.Benchmark
{
    ...
    public class RepositoryLargeTests
    {
        ...
        {
            var options = new DbContextOptionsBuilder<DataContext>().UseSqlServer("Server=(localdb)\\mssqllocaldb;Database=ProductCaseBanchmark;Trusted_Connection=True;MultipleActiveResultSets=true")
            ...
            SeedData.SeedDatabaseLarge(this._mockDataContext);
        }
